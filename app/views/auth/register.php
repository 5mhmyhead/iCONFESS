<div class="form-container">
    ...
    <form id="register-form">
        ...
        <div class="form-group">
            <label class="section-label">Choose account type</label>
            <div class="role-grid">
                <label class="role-card">
                    ...
                    <div class="role-content">
                        ...
                        <span class="role-desc">For exploring, reading, and interacting with community confessions anonymously.</span>
                    </div>
                </label>
                <label class="role-card">
                    ...
                    <div class="role-content">
                        ...
                        <span class="role-desc">For managing incoming flags, reviewing content quality, and curation tools.</span>
                    </div>
                </label>
            </div>
        </div>
